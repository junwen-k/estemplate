...
var (
	...
	validTermVector   = []string{"no", "yes", "with_positions", "with_offsets", "with_positions_offsets", "with_positions_payloads", "with_positions_offsets_payloads"}
	// See https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#field.detail
	// for details.
	validLocale = []string{"ENGLISH", "FRENCH", "GERMAN", "ITALIAN", "JAPANESE", "KOREAN", "CHINESE", "SIMPLIFIED_CHINESE", "TRADITIONAL_CHINESE", "FRANCE", "GERMANY", "ITALY", "JAPAN", "KOREA", "CHINA", "PRC", "TAIWAN", "UK", "US", "CANADA", "CANADA_FRENCH", "ROOT", "PRIVATE_USE_EXTENSION", "UNICODE_LOCALE_EXTENSION"}
	// See https://www.elastic.co/guide/en/elasticsearch/reference/7.5/mapping-date-format.html
	// for details.
	builtInDateFormats = []string{
